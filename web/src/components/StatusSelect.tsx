...
type Status = "idle" | "running" | "awaiting_review" | "awaiting_script_approval" | "awaiting_media_approval" | "ready_for_phase3" | "done" | "error" | "rejected" | "paused_until";
...
const styles: Record<Status, string> = {
  ...
  awaiting_script_approval: "text-amber-torchlight bg-amber-torchlight/10",
...
const ALL: Status[] = ["idle", "running", "awaiting_review", "awaiting_script_approval", "awaiting_media_approval", "ready_for_phase3", "done", "error", "rejected", "paused_until"];
